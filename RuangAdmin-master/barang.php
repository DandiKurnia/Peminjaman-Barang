            ...
            <div class="col-lg-12 mb-4">
              ...
              <div class="card">
                <div class="card-header d-flex flex-row align-items-center justify-content-between">
                  ...
                  <button type="button" class="m-0 float-right btn btn-primary btn-sm ml-5" data-toggle="modal" data-target="#examplemodal2"
                    id="#myBtn">Create <i
                  ...
                  <table class="table border ">
                    ...
                    $sql ="SELECT * FROM barang";
                      ...
                      while($no =mysqli_fetch_array($query)){
                          ...
                          echo "<a href='hapusbarang.php?id_barang=".$no['id_barang']."' class='btn btn-danger'>Hapus</a>";
                          echo "</td>";
                          echo "</tr>";
                        }
                      ?>
