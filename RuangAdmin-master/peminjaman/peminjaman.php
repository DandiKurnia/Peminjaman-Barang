...
<head>
  ...
  <title>RuangAdmin - Tables Peminjaman</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800 ml-3">Tables Peminjaman</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
              <li class="breadcrumb-item">Tables</li>
              <li class="breadcrumb-item active" aria-current="page">Tables Peminjaman</li>
            </ol>
          </div>
                ...
                <div class="table-responsive p-3">
                  <table class="table align-items-center table-flush" id="dataTable">
                    ...
                    while ($no = mysqli_fetch_array($query)) {
                      ...
                      echo "<td>" . $no['tanggal_peminjaman'] . "</td>";
                  ...
                  <div class="modal-body">
                    ...
                    <body>
                      <form action="simpan.php" method="POST">
                        <div class="container">
                          <h3 class="border-bottom mt-3 mb-3">Input Peminjaman</h3>
                          <div class="form-group">
                            ...
                            <div class="form-group">
                              ...
                              <select name="id_pengguna" class="form-control" require>
                                ...
                                <?php
                                $sqlpengguna = mysqli_query($connect, "SELECT * FROM pengguna ") or die(mysqli_error($connect));

                                while ($pengguna = mysqli_fetch_array($sqlpengguna)) {
                                  echo '<option value="' . $pengguna['id_pengguna'] . '">
                                  ' . $pengguna['id_pengguna'] . '</option>';
                                }
                                ?>
                              </select>
                              <div class="form-group">
                                <label class="mr-2 mt-3">Nama Barang :</label>
