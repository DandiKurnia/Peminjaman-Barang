...
<head>
  ...
  <title>RuangAdmin - Tables User</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800 ml-3">Tables Barang</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
              <li class="breadcrumb-item">Tables</li>
              <li class="breadcrumb-item active" aria-current="page">Tables Barang</li>
            </ol>
          </div>
                ...
                <div class="table-responsive p-3">
                  <table class="table align-items-center table-flush" id="dataTable">
                    ...
                    while ($no = mysqli_fetch_array($query)) {
                      ...
                      echo "<td>";
                      echo "<a href='formeditbarang.php?id_barang=" . $no['id_barang'] . "' class='btn btn-warning'>Edit</a>  ";
                      ...
                      <form action="simpanbarang.php" method="POST">
                        <div class="container">
                          ...
                          <div class="form-group">
                            ...
                            <select name="id_barang" class="form-control" require>
                          ...
                          <div class="form-group">
                            ...
                            <select name="nama_barang" class="form-control" require>
                              ...
                              <?php
                              $sqlnama = mysqli_query($connect, "SELECT * FROM inventory ") or die(mysqli_error($connect));

                              while ($nama_brng = mysqli_fetch_array($sqlnama)) {
                                echo '<option value="' . $nama_brng['nama_barang'] . '">
                                  ' . $nama_brng['nama_barang'] . '</option>';
                              }
                              ?>
                            </select>
                          </div>
                          <div class="modal-footer">
                            ...
                            <button type="submit" name="simpanbarang" value="simpanbarang" class="btn btn-primary">Save changes</button>
                          </div>
                        </div>
                  </div>
                </div>
