      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800 ml-3">Table User</h1>
            <ol class="breadcrumb">
                  ...
                  <div class="table-responsive p-3">
                    <table class="table align-items-center table-flush" id="dataTable">
                      ...
                      while ($no = mysqli_fetch_array($query)) {
                        ...
                        echo "<td>" . $no['nama_pengguna'] . "</td>";
                        echo "<td>" . $no['email'] . "</td>";
                        echo "<td>" . $no['no_telepon'] . "</td>";

                        echo "<td class='mt-10'>";
                        echo "<a href='formedituser.php?id_pengguna=" . $no['id_pengguna'] . "' class='btn btn-warning'>Edit</a>  ";
                        echo "<a href='hapususer.php?id_pengguna=" . $no['id_pengguna'] . "' class='btn btn-danger'>Hapus</a>";
                        echo "</td>";
                        echo "</tr>";
                      }
                      ?>
                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      ...
                      <button type="submit" name="simpanuser" value="simpan" class="btn btn-primary">Save changes</button>
                    </div>
                  </div>
                </div>
              </div>
