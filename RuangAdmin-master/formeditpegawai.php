...
include 'koneksi.php';
$id_b = $_GET['id_barang'];
$sql = "SELECT * FROM inventory WHERE id_barang='$id_b'";
...
<body>
  <div class="container">
    <form action="edit.php" method="POST">
      <input type="hidden" name="id_pe" value="<?php echo $no['id_barang'] ?>">
      ...
      <div class="form-group">
        <label>Status</label>
        <input type="text" class="form-control" name="status" value="<?php echo $no['status'] ?>">
      </div>
      <div class="form-group">
        <label>stok</label>
