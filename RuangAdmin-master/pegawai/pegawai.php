...
<head>
  ...
  <title>RuangAdmin - Tables pegawai</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800 ml-3">Tables Pegawai</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
              <li class="breadcrumb-item">Tables</li>
              <li class="breadcrumb-item active" aria-current="page">Tables Pegawai</li>
            </ol>
          </div>
                  ...
                  <div class="table-responsive p-3">
                    <table class="table align-items-center table-flush" id="dataTable">
                      ...
                      while ($no = mysqli_fetch_array($query)) {
                        ...
                        echo "<td>" . $no['email'] . "</td>";
                        echo "<td>" . $no['no_telepon'] . "</td>";

                        echo "<td class='mt-10'>";
                        echo "<a href='formeditpegawai.php?id_pegawai=" . $no['id_pegawai'] . "' class='btn btn-warning'>Edit</a>  ";
                        echo "<a href='hapuspegawai.php?id_pegawai=" . $no['id_pegawai'] . "' class='btn btn-danger'>Hapus</a>";
                        echo "</td>";
                        echo "</tr>";
                      }
                      ?>
                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      ...
                      <button type="submit" name="simpanpegawai" value="simpan" class="btn btn-primary">Save changes</button>
                    </div>
                  </div>
                </div>
              </div>
