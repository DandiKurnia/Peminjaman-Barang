<?php
include 'koneksi.php';
$get1 = mysqli_query($connect, "select * from barang");
$count1 = mysqli_num_rows($get1);
// untuk menghitung data pegawai
$get2 = mysqli_query($connect, "select * from pegawai");
$count2 = mysqli_num_rows($get2);
// untuk menghitung data user
$get3 = mysqli_query($connect, "select * from pengguna");
$count3 = mysqli_num_rows($get3);
// untuk menghitung data peminjaman
$get4 = mysqli_query($connect, "select * from peminjaman");
            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header d-flex flex-row align-items-center justify-content-between">
                  ...
                  <button type="button" class="m-0 float-right btn btn-primary btn-sm ml-5" data-toggle="modal" data-target="#examplemodal2" id="#myBtn">Create <i class="fas fa-chevron-right"></i></a>
                </div>
                <div class="table-responsive">
                  <table class="table align-items-center table-flush" id="datatablesSimple">
                    ...
                    while ($no = mysqli_fetch_array($query)) {
                      ...
                      echo "<td class='mt-10'>";
                      echo "<a href='formeditpegawai.php?id_barang=" . $no['id_barang'] . "' class='btn btn-warning'>Edit</a>  ";
                      echo "<a href='hapuspegawai.php?id_barang=" . $no['id_barang'] . "' class='btn btn-danger'>Hapus</a>";
                      echo "</td>";
                      echo "</tr>";
                    }
                    ?>
